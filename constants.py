...
BASIC_MOVE_TICKS  = 8    # Slow (Original 4 doubled for 30 FPS)
FAST_MOVE_TICKS   = 4    # Fast (Original 2 doubled for 30 FPS)
ARMOR_MOVE_TICKS  = 6    # Medium (Original 3 doubled for 30 FPS)
PLAYER_MOVE_TICKS = 4    # Matches Fast speed

BASIC_FIRE_TICKS  = 90   # 3.0s
FAST_FIRE_TICKS   = 45   # 1.5s
ARMOR_FIRE_TICKS  = 60   # 2.0s
PLAYER_FIRE_TICKS = 30   # 1.0s

BULLET_SPEED_TICKS = 2   # moves every 2nd tick (2x tank speed)
